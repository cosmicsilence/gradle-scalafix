...
class ScalafixPropsTest extends Specification {
    ...
    def 'it should return the supported Scala version for a #projectScalaVersion project'() {
        ...
        '2.12.13'           || ScalafixProps.supportedScala212Version
    ...
    def 'it should return the scalafix-cli artifact coordinates for a #projectScalaVersion project'() {
        ...
        '2.11.12'           || "ch.epfl.scala:scalafix-cli_${ScalafixProps.supportedScala211Version}:${ScalafixProps.scalafixVersion}"
        '2.12.13'           || "ch.epfl.scala:scalafix-cli_${ScalafixProps.supportedScala212Version}:${ScalafixProps.scalafixVersion}"
    ...
    def 'it should return the semanticdb artifact coordinates for a #projectScalaVersion project'() {
        ...
        '2.12.13'           || "org.scalameta:semanticdb-scalac_${projectScalaVersion}:${ScalafixProps.scalametaVersion}"
